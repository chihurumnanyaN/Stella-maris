...
const images = ["/stella4.jpg", "/hero1.png", "/hero2.jpg"];
          ...
          {images.map((src, idx) => (
            <SwiperSlide key={idx}>
              <div className="relative w-full h-[80vh] md:h-[90vh] overflow-hidden">
                ...
                />
                {/* Optional Overlay */}
                <div className="absolute inset-0 bg-black/30  flex flex-col justify-center items-center px-6 md:px-20">
                  <span className="text-xl md:text-2xl text-orange-400 font-bold">
                    {" "}
                    Welcome to
                  </span>
                  <h1 className="text-white text-center text-4xl md:text-8xl font-bold mb-4">
                    Stella Maris Parish
                  </h1>
